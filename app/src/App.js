  ...
  return (
    <div className="bg-white dark:bg-dark seceltion font-Inter">
      ...
      <div className="fixed top-0 left-0 z-50 w-full">
        <div className="px-4 py-4 lg:px-8 lg:py-1" id="header">
          <div className="flex items-center justify-between">
            <div className="logo">
              <a href="#main"><img src="./img/logo.svg" alt="logo" className="block dark:hidden w-44" /></a>
            </div>
            <div className="navigation hidden lg:block">

              <nav>
                <ul className="flex items-center justify-between">
                  <li className="px-6 py-4"><a href="#features" className="menu-item">Features</a></li>
                  <li className="px-6 py-4"><a href="#demo" className="menu-item">Demo</a></li>
                  <li className="px-6 py-4"><a href="#pricing" className="menu-item">Pricing</a></li>
                  <li className="px-6 py-4"><a href="#contact-us" className="menu-item">Contact Us</a></li>
                </ul>
              </nav>
            </div>
            <div className="panel flex items-center">
              <a href="" className="btn cursor-pointer text-neutral-900 py-3 px-2 hidden lg:block">Login</a>
              <a href="" className="btn cursor-pointer bg-[#EC9A00] mr-6 py-3 hidden lg:block">sign Up</a>
            </div>
          </div>
        </div>
      </div>
      <div className="main" id="main">
        <div className="relative flex items-center h-screen px-4 lg:px-0 bg-white dark:bg-dark">
          <div className="sticky z-10 w-full lg:w-2/5 2xl:w-1/2 mx-auto text-center">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center mt-8 p-6">
              <a href="#pricing" className="btn bg-[#EC9A00]">Get Started</a>
              <a href="#features"
            ...
            <div className="container-language-options mt-8">
              <img src="./img/LangOptions/Frame 4.png" className="language-option" alt="Option Language" />
              <img src="./img/LangOptions/Frame 5.png" className="language-option" alt="Option Language" />
              <img src="./img/LangOptions/Frame 6.png" className="language-option" alt="Option Language" />
              <img src="./img/LangOptions/Frame 7.png" className="language-option" alt="Option Language" />
              <img src="./img/LangOptions/Frame 8.png" className="language-option" alt="Option Language" />
              <img src="./img/LangOptions/Frame 9.png" className="language-option" alt="Option Language" />
            </div>
          </div>
        ...
        <div className="py-20 md:py-24 bg-[#efefef] dark:bg-[#0b113a]" id="features">
        ...
        <div className="bg-white dark:bg-dark py-20 md:py-24" id="pricing">
        ...
        <div className="contact-us py-16 bg-white dark:bg-dark" id="contact-us">
          <div
          ...
          <div className="top-content py-16 bg-[#fffff] bg-opacity-5">
            <div
              ...
              <div className="basis-1/2 md:basis-1/3 lg:basis-[15%] my-6 lg:my-0">
                ...
                <p className="my-3"><a href="" className="text-gray-500 dark:text-gray-400 font-medium">Blog</a></p>
                <p className="my-3"><a href="" className="text-gray-500 dark:text-gray-400 font-medium">Pricing</a></p>
                <p className="my-3"><a href="" className="text-gray-500 dark:text-gray-400 font-medium">About</a></p>
              </div>
              <div className="basis-1/2 md:basis-1/3 lg:basis-[15%] my-6 lg:my-0">
                <h4 className="heading text-xl mb-7">Terms</h4>
                <p className="my-3"><a href="" className="text-gray-500 dark:text-gray-400 font-medium">TOS</a></p>
                <p className="my-3"><a href="" className="text-gray-500 dark:text-gray-400 font-medium">Privacy
                  Policy</a>
                </p>
                <p className="my-3"><a href="" className="text-gray-500 dark:text-gray-400 font-medium">Refund
                  Policy</a>
                </p>
              </div>
              <div className="basis-1/2 md:basis-1/3 lg:basis-[15%] my-6 lg:my-0">
                <h4 className="heading text-xl mb-7">Support & Help</h4>
                <p className="my-3"><a href="" className="text-gray-500 dark:text-gray-400 font-medium">Open Support
                  Ticket</a>
                </p>
                <p className="my-3"><a href="" className="text-gray-500 dark:text-gray-400 font-medium">Terms of Use</a>
                </p>
                <p className="my-3"><a href="" className="text-gray-500 dark:text-gray-400 font-medium">About</a></p>
              </div>
            </div>
